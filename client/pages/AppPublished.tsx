...
export default function AppPublished({appPublishedUrl} : {appPublishedUrl: string}) {
    ...
    return (
      ...
      >
            ...
            <Text style={styles.paragraph}>Great news! Our app is now live on the App Store. Please switch from the demo version to enjoy all the new and exclusive features waiting for you. Update today!</Text>
            <Button
